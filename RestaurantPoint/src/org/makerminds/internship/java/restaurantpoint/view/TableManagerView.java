...
private static List<Tables> list=tableManagerController.getListofTables();
...
private List<Restaurant>listOfRestaurants=restaurantManagerController.getListOfRestaurants();
	...
	private static String[][] createTableArray() {
		...
		while(it.hasNext()) {
			...
			multidimensionalArray[i][0]=Integer.toString(table.getTableNumber());  
			multidimensionalArray[i][1]=Integer.toString(table.getTableCapacity());  
			i++;
		}
	...
	private static void addButtonFunction(){
		...
		public void actionPerformed(ActionEvent e) {
			list.add(new Tables(Integer.valueOf(textField.getText()) ,Integer.valueOf(textField1.getText())));
			prepareTableDataTable();
