...
/**	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RestaurantManagerView1 window = new RestaurantManagerView1();
	...
	/**public void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 984, 519);
	...
	public static JPanel createContentPanel() {
		...
		contentPanel.setBounds(266,0,904,682);
		...
		//TitledBorder titledBorder=BorderFactory.createTitledBorder("RM");
