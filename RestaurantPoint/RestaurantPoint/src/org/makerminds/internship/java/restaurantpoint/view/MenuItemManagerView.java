...
public class MenuItemManagerView {
	...
	private static JRadioButton rdbtnNewRadioButton = new JRadioButton("Meal");
	private static JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Drink");
	...
	private static List<List<Menu>>listOfMenus=managerController.getListOfMenus();
	private static List<Menu>list1Menu=listOfMenus.get(0);
	private static List<Menu>list2Menu=listOfMenus.get(1);
	private static List<Menu>list3Menu=listOfMenus.get(2);
		...
		TitledBorder titledBorder2=BorderFactory.createTitledBorder("RESTAURANT SELECTION");
			 ...
			 listComboBox.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						// int i=listMenuComboBox.getSelectedIndex();
						 if(j==0) {
							 listMenuComboBox.setModel(new DefaultComboBoxModel<Menu>(list1Menu.toArray(new Menu[0])));
							 listMenuComboBox.setSelectedItem(null);
						 }else if(j==1) {
								 listMenuComboBox.setModel(new DefaultComboBoxModel<Menu>(list2Menu.toArray(new Menu[0])));
								 listMenuComboBox.setSelectedItem(null);
						 }else if(j==2) {
								 listMenuComboBox.setModel(new DefaultComboBoxModel<Menu>(list3Menu.toArray(new Menu[0])));
								 listMenuComboBox.setSelectedItem(null);
						 }
					}
	...
	public static void prepareMenuDataTable() {
		String  [] tableHeader= {"ID","Name","Price"};
			String [] [] menuItemListMultidimensionalArray1= createMenuArray();
			menuItemTableModel.setDataVector(menuItemListMultidimensionalArray1, tableHeader);	
		}

	private static String[][] createMenuArray() {
		
		//String [][]  menuItemListMultidimensionalArray1 =new String[listOfLists.get(0).size()][3];
		int j=listMenuComboBox.getSelectedIndex();
		if(j==0) {
			menuItemListMultidimensionalArray =new String[list1.size()][3];
		int i=0;
		...
		if(j==1) {
			int i=0;
			menuItemListMultidimensionalArray =new String[list2.size()][3];
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(i==0) {
					if(rdbtnNewRadioButton.isSelected()) {
						...
						list1.add(new Meal(textField2.getText(),Integer.valueOf(textField.getText()), Double.valueOf(textField3.getText())));
					}
					if(rdbtnNewRadioButton_1.isSelected()) {
						list1.add(new Drink(textField2.getText(),Integer.valueOf(textField.getText()), Double.valueOf(textField3.getText())));
					}
	...
	prepareMenuDataTable();
		...
		if(rdbtnNewRadioButton.isSelected()) {
			...
			list2.add(new Meal(textField2.getText(),Integer.valueOf(textField.getText()), Double.valueOf(textField3.getText())));
		}
		if(rdbtnNewRadioButton_1.isSelected()) {
			
			list2.add(new Drink(textField2.getText(),Integer.valueOf(textField.getText()), Double.valueOf(textField3.getText())));
		}
	prepareMenuDataTable();
	}
